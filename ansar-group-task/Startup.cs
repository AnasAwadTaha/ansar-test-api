...
namespace ansar_group_task
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<RegisterServices>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ansar_group_task", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ansar_group_task v1"));
            }
            app.UseRouting();
